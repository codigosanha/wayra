...
//-----------------------------------------------------------------------------------------------
   ...
   //--------------------PRESENTACION DE JTABLE PRODUCTO----------------------
    ...
    private void initComponents() {
        ...
        rbtnCodigo.setForeground(new java.awt.Color(0, 0, 255));
        ...
        rbtnNombre.setForeground(new java.awt.Color(0, 0, 255));
        ...
        rbtnDescripcion.setForeground(new java.awt.Color(0, 0, 255));
